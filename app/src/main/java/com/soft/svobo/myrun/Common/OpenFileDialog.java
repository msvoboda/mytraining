...
public class OpenFileDialog extends AlertDialog.Builder {
    ...
    public OpenFileDialog(Context context) {
        ...
        /*
        check1 = createCheckBox(context, "First point - Start");
        check2 = createCheckBox(context, "Last point - End");
        linearLayout.addView(check1);
        linearLayout.addView(check2);*/
    ...
    private CheckBox createCheckBox(Context context, String label)
    {
        CheckBox checkView = new CheckBox(context);
        checkView.setText(label);
        int itemHeight = getItemHeight(context);
        checkView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, itemHeight));
        return checkView;
    }
