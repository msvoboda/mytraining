...
public class GpxRouteImporter {
    ...
    protected void onStartElement() {
        ...
        else if ("trkpt".equals(currEl))
        {
            ...
            if(firstPoint==null)
            {
                ...
                new_point.lat = Double.valueOf(lat);
                new_point.lon = Double.valueOf(lon);
                new_point.name = "Start";
                pointList.add(0,new_point);
                trackList.add(new_point);
    ...
    private void calculateSplits(){
        pointList.calculateSplits();
        trackList.calculateSplits();
    }
}
